  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 mb-9 sm:mb-14">
        <span className="font-mono text-[12.5px] tracking-[1px] text-accent">
          About
        </span>
      ...
      <h1
        ...
        className="font-serif font-medium text-[40px] sm:text-[68px] lg:text-[92px] xl:text-[104px] leading-[0.98] tracking-[-0.03em] max-w-[15ch] text-balance"
      >
      ...
      <Photo
        ...
        className="mt-9 sm:mt-14 rounded-[20px] aspect-[16/9] sm:aspect-[16/7] sm:min-h-[220px] shadow-[0_30px_70px_-40px_rgba(34,29,23,0.5)]"
      />
    </section>
  );
}
