  ...
  return (
    <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
      {resources.map(function (r) {
        return (
          <Tap key={r.slug} className="block h-full">
            <a
              href="#"
              className="group flex flex-col h-full bg-background border border-border rounded-[18px] overflow-hidden hover:border-primary transition-colors"
            >
              <Photo
