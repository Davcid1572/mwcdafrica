...
const stats = [
  { value: "47+", label: "Communities reached", sublabel: "across 6 regions" },
  {
    value: "18",
    label: "Programs delivered",
    sublabel: "Workshops & campaigns",
  },
  { value: "12", label: "Partnerships built", sublabel: "Institutions & NGOs" },
  { value: "3,353+", label: "Individuals supported", sublabel: "and counting" },
];
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-end justify-between gap-6 mb-12 sm:mb-16">
        ...
        <Link
          href="/impact"
          className="text-[14px] font-semibold text-foreground underline decoration-accent decoration-2 underline-offset-4 hover:text-accent transition-colors"
        >
          Read the impact report &rarr;
        </Link>
      </div>
