...
function BigCard() {
  return (
    <div className="bg-[#1F3A2E] text-[#F7F2EA] rounded-2xl p-6 sm:p-8 flex flex-col justify-end min-h-[220px] sm:min-h-[340px]">
      <span className="font-mono text-[12px] text-[#F7F2EA]/50 mb-3">01</span>
      ...
      <div className="flex flex-col gap-3 sm:hidden">
        ...
        {smallCards.map(function (card) {
          return (
            <div
              key={card.n}
              className="bg-[#1F3A2E] text-[#F7F2EA] rounded-2xl p-5 flex flex-col justify-end min-h-[100px]"
            >
        ...
        {smallCards.map(function (card) {
          return (
            <div
              ...
              className="bg-[#1F3A2E] text-[#F7F2EA] rounded-2xl p-6 flex flex-col justify-end min-h-[150px]"
            >
              <span className="font-mono text-[11px] text-[#F7F2EA]/50 mb-2">
                {card.n}
              </span>
              <h3 className="text-[16px] font-medium leading-[1.25]">
                {card.title}
              </h3>
            </div>
          );
